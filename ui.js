globalThis.UI = {
  ...
  _injectStyles() {
    ...
    style.textContent = [
      ...
      '.ui-btn-confirm{background:#FAFAFA;color:#0E0E10;}',
      '.ui-btn-confirm:hover{opacity:0.88;}',
      '.ui-btn-confirm.ui-danger{background:#FF5C5C;color:#0E0E10;}',
      '.ui-btn:focus-visible{outline:2px solid #FAFAFA;outline-offset:2px;}',
      ...
      '.ui-toast.ui-success{background:rgba(250,250,250,0.08);border:1px solid rgba(250,250,250,0.3);color:#FAFAFA;}',
