globalThis.UI = {
  ...
  _injectStyles() {
    ...
    style.textContent = [
      ...
      '.ui-btn-confirm{background:#FCD34D;color:#0E0E10;}',
      '.ui-btn-confirm:hover{opacity:0.88;}',
      '.ui-btn-confirm.ui-danger{background:#FF5C5C;color:#0E0E10;}',
      '.ui-btn:focus-visible{outline:2px solid #FCD34D;outline-offset:2px;}',
      ...
      '.ui-toast.ui-success{background:rgba(252,211,77,0.1);border:1px solid rgba(252,211,77,0.35);color:#FCD34D;}',
